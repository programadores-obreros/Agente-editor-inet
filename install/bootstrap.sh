...
echo ""
echo "  🔑 Falta un paso único: conectar una API key gratis de Google (sin tarjeta)"
echo "     para el modelo de lenguaje. Sacala en https://aistudio.google.com/apikey,"
echo "     después en OpenCode escribí '/connect', elegí Google/Gemini y pegala."
echo ""
