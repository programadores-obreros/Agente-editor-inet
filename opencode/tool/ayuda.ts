...
Comandos: \`/diagnostico\` (revisa que todo esté listo) · \`/reparar\` (instala lo que falte, PlatformIO incluido) · \`/actualizar\` (última versión) · \`/clave\` (ver, probar o cambiar tu key de Google) · \`/ayuda\` (esto mismo).`
