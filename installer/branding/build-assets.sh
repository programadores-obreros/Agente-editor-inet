...
# Logo chico (arriba a la derecha del asistente, sobre fondo blanco): isotipo Tecnia Lab.
magick tecnialab/isotipo.png -resize 46x -background white -gravity center -extent 55x58 -type truecolor BMP3:wizard-chico.bmp
